...
This is the complete guide for end-to-end testing in the CRM Frontend project
using Playwright.
...
Tests are organized to **exactly mirror** your CRM application structure from
`src/app/(protected)/(features)/`:
...
✅ **Developer Workflow**: Feature developers know exactly where their tests
live  
...
test.describe('Product Management', () => {
  test.describe('Product List Page', () => {
    ...
    test('should display products with essential information', async ({
      page,
    }) => {
...
{
  FeatureName;
} // e.g., "Product", "Customer", "Call"
{
  featureName;
} // e.g., "product", "customer", "call"
{
  feature - path;
} // e.g., "products", "customers", "calls"
```
...
// Good
test(
  'should create call with customer association and auto-populate contact details'
);
...
You now have a comprehensive, feature-aligned Playwright testing infrastructure
that:
...
**Single Source of Truth**: This README is your complete testing guide. No need
to reference multiple documentation files.
