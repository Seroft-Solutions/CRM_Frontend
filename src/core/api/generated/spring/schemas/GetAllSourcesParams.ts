...
'costPerLead.greaterThan'?: number;
'costPerLead.lessThan'?: number;
'costPerLead.greaterThanOrEqual'?: number;
'costPerLead.lessThanOrEqual'?: number;
'costPerLead.equals'?: number;
'costPerLead.notEquals'?: number;
'costPerLead.specified'?: boolean;
'costPerLead.in'?: number[];
'costPerLead.notIn'?: number[];
'conversionRate.greaterThan'?: number;
'conversionRate.lessThan'?: number;
'conversionRate.greaterThanOrEqual'?: number;
'conversionRate.lessThanOrEqual'?: number;
'conversionRate.equals'?: number;
'conversionRate.notEquals'?: number;
'conversionRate.specified'?: boolean;
'conversionRate.in'?: number[];
'conversionRate.notIn'?: number[];
