 ...
 */
import type { GetAllSundryCreditorsStatusEquals } from './GetAllSundryCreditorsStatusEquals';
import type { GetAllSundryCreditorsStatusNotEquals } from './GetAllSundryCreditorsStatusNotEquals';
import type { GetAllSundryCreditorsStatusInItem } from './GetAllSundryCreditorsStatusInItem';
import type { GetAllSundryCreditorsStatusNotInItem } from './GetAllSundryCreditorsStatusNotInItem';

export type GetAllSundryCreditorsParams = {
...
'status.equals'?: GetAllSundryCreditorsStatusEquals;
'status.notEquals'?: GetAllSundryCreditorsStatusNotEquals;
'status.specified'?: boolean;
'status.in'?: GetAllSundryCreditorsStatusInItem[];
'status.notIn'?: GetAllSundryCreditorsStatusNotInItem[];
