 ...
 */
import type { GetAllProductVariantsStatusEquals } from './GetAllProductVariantsStatusEquals';
import type { GetAllProductVariantsStatusNotEquals } from './GetAllProductVariantsStatusNotEquals';
import type { GetAllProductVariantsStatusInItem } from './GetAllProductVariantsStatusInItem';
import type { GetAllProductVariantsStatusNotInItem } from './GetAllProductVariantsStatusNotInItem';

export type GetAllProductVariantsParams = {
...
'status.equals'?: GetAllProductVariantsStatusEquals;
'status.notEquals'?: GetAllProductVariantsStatusNotEquals;
'status.specified'?: boolean;
'status.in'?: GetAllProductVariantsStatusInItem[];
'status.notIn'?: GetAllProductVariantsStatusNotInItem[];
