...
'remark.in'?: string[];
'remark.notIn'?: string[];
'status.equals'?: GetAllProductCategoriesStatusEquals;
'status.notEquals'?: GetAllProductCategoriesStatusNotEquals;
'status.specified'?: boolean;
'status.in'?: GetAllProductCategoriesStatusInItem[];
'status.notIn'?: GetAllProductCategoriesStatusNotInItem[];
