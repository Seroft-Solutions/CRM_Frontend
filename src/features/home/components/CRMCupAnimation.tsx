  ...
  return (
    <div className="relative w-72 h-72 cursor-pointer" onClick={() => setIsAnimating(!isAnimating)}>
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {/* Handle */}
        <path d="M80 50 Q95 50 95 65 Q95 80 80 80" fill="none" className="stroke-primary" strokeWidth="5"/>

        {/* CRM letters */}
        {isAnimating && (
          <>
            <text x="35" y="35" fontFamily="Arial" fontSize="14" className="fill-primary-foreground font-bold"
              opacity="0.8">
              <animate 
                attributeName="y" 
                values="35;25;35" 
            ...
            <text x="50" y="35" fontFamily="Arial" fontSize="14" className="fill-primary-foreground font-bold"
              opacity="0.8">
              <animate 
                attributeName="y" 
                values="35;20;35" 
            ...
            <text x="65" y="35" fontFamily="Arial" fontSize="14" className="fill-primary-foreground font-bold"
              opacity="0.8">
              <animate 
                attributeName="y" 
                values="35;25;35" 
