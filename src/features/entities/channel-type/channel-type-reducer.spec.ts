...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANNELTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CHANNELTYPES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHANNELTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHANNELTYPE actions', async () => {
      const arg = { id: 14430 };
    ...
    it('dispatches UPDATE_CHANNELTYPE actions', async () => {
      const arg = { id: 14430 };
    ...
    it('dispatches PARTIAL_UPDATE_CHANNELTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHANNELTYPE actions', async () => {
      const arg = 42666;
