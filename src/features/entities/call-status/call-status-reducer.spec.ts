...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALLSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CALLSTATUSES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALLSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALLSTATUS actions', async () => {
      const arg = { id: 12000 };
    ...
    it('dispatches UPDATE_CALLSTATUS actions', async () => {
      const arg = { id: 12000 };
    ...
    it('dispatches PARTIAL_UPDATE_CALLSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CALLSTATUS actions', async () => {
      const arg = 42666;
