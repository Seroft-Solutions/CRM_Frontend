  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crmBackendApp.state.home.createOrEditLabel" data-cy="StateCreateUpdateHeading">
            <Translate contentKey="crmBackendApp.state.home.createOrEditLabel">Create or edit a State</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('crmBackendApp.state.name')}
                id="state-name"
                name="name"
                data-cy="name"
                type="text"
