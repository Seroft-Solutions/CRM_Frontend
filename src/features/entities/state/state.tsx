...
import { getEntities, searchEntities } from './state.reducer';
...
export const State = () => {
  ...
  const totalItems = useAppSelector(state => state.state.totalItems);
  ...
  return (
    <div>
      <h2 id="state-heading" data-cy="StateHeading">
        <Translate contentKey="crmBackendApp.state.home.title">States</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="crmBackendApp.state.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/state/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="crmBackendApp.state.home.createLabel">Create new State</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('crmBackendApp.state.home.search')}
                />
        ...
        {stateList && stateList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="crmBackendApp.state.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="crmBackendApp.state.name">Name</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="crmBackendApp.state.home.notFound">No States found</Translate>
            </div>
          )
        )}
      </div>
