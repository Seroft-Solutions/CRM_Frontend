...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALLTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CALLTYPES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALLTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALLTYPE actions', async () => {
      const arg = { id: 8493 };
    ...
    it('dispatches UPDATE_CALLTYPE actions', async () => {
      const arg = { id: 8493 };
    ...
    it('dispatches PARTIAL_UPDATE_CALLTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CALLTYPE actions', async () => {
      const arg = 42666;
