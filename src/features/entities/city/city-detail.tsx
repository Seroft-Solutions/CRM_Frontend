    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cityDetailsHeading">
          <Translate contentKey="crmBackendApp.city.detail.title">City</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="crmBackendApp.city.name">Name</Translate>
            </span>
          </dt>
          <dd>{cityEntity.name}</dd>
          <dt>
            <Translate contentKey="crmBackendApp.city.district">District</Translate>
          </dt>
          <dd>{cityEntity.district ? cityEntity.district.id : ''}</dd>
        </dl>
