...
import { deleteEntity, getEntity } from './call.reducer';
...
export const CallDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/call${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmBackendApp.call.delete.question">
        <Translate contentKey="crmBackendApp.call.delete.question" interpolate={{ id: callEntity.id }}>
