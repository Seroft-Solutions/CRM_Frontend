...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CALLS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALL actions', async () => {
      const arg = { id: 31145 };
    ...
    it('dispatches UPDATE_CALL actions', async () => {
      const arg = { id: 31145 };
    ...
    it('dispatches PARTIAL_UPDATE_CALL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CALL actions', async () => {
      const arg = 42666;
