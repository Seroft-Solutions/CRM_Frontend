...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCALLTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUBCALLTYPES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBCALLTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBCALLTYPE actions', async () => {
      const arg = { id: 6766 };
    ...
    it('dispatches UPDATE_SUBCALLTYPE actions', async () => {
      const arg = { id: 6766 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBCALLTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBCALLTYPE actions', async () => {
      const arg = 42666;
