// app/api/keycloak/organizations/[organizationId]/details/route.ts (updated)
...
export async function GET(
    ...
    try {
        ...
        const organizationData: OrganizationRepresentation = await getAdminRealmsRealmOrganizationsOrgId(
            realm,
            organizationId
        );
