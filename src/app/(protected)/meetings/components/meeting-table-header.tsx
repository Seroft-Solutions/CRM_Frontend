    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          <Button
            variant="ghost"
            onClick={() => onSort('organizer.email')}
            className="flex items-center gap-1.5 h-auto px-2 py-1 font-medium text-gray-700 hover:text-gray-900 hover:bg-white rounded text-sm transition-colors"
          >
            Organizer
            <div className="text-gray-400">{renderSortIcon('organizer.email')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          <Button
            variant="ghost"
            onClick={() => onSort('assignedParty.name')}
            className="flex items-center gap-1.5 h-auto px-2 py-1 font-medium text-gray-700 hover:text-gray-900 hover:bg-white rounded text-sm transition-colors"
          >
            Assigned Party
            <div className="text-gray-400">{renderSortIcon('assignedParty.name')}</div>
          </Button>
        </TableHead>
      ...
      <TableRow className="border-b bg-white">
        ...
        <TableHead className="px-3 py-2">
          <Input
            placeholder="Filter..."
            className="h-8 text-xs border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-gray-400"
            value={(filters['organizer.email'] as string) || ''}
            onChange={(e) => onFilterChange('organizer.email', e.target.value || undefined)}
          />
        </TableHead>
        ...
        <TableHead className="px-3 py-2">
          <Input
            placeholder="Filter..."
            className="h-8 text-xs border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-gray-400"
            value={(filters['assignedParty.name'] as string) || ''}
            onChange={(e) => onFilterChange('assignedParty.name', e.target.value || undefined)}
          />
        </TableHead>
