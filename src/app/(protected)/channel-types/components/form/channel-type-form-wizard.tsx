  ...
  const { mutate: createEntity, isPending: isCreating } = useCreateChannelType({
    mutation: {
      onSuccess: (data) => {
        ...
        console.log('🟢 ChannelType created successfully with ID:', entityId);
        ...
        if (hasReferrer() && entityId) {
          ...
          console.log('🟢 No referrer, going to channel-types list');
          setIsRedirecting(true);
      ...
      onError: (error) => {
        console.error('🔴 ChannelType creation failed:', error);
