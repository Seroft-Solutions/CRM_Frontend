  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardDescription>
            Viewing details for Channel Type #id{entity.id}
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="border-l-4 border-primary/20 pl-4 py-2">
                    <dt className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Commission Rate</dt>
                    <dd className="text-base font-medium">
          ...
          <div className="flex justify-end gap-3 mt-8 pt-6 border-t">
            <Button variant="outline" asChild>
              <Link href={`/channel-types/${id}/edit`} className="flex items-center gap-2">
