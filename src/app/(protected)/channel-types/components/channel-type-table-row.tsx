...
export function ChannelTypeTableRow({
  ...
  return (
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-3 py-2">{channelType.name}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{channelType.description}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{channelType.commissionRate}</TableCell>
