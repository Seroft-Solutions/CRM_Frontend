...
// - Purpose: Display import instructions for call type data and a file input field
...
const importConfig = {
  ...
  filename: "calltype_import_template.xlsx",
  columns: [
    {
      header: "Name",
      column: "A",
      example: "Customer Support",
      description: "CallType name (Required, 2-50 characters)",
    },
    {
      header: "Description",
      column: "B",
      example: "Handle customer inquiries and support requests",
      description: "CallType description (Optional, max 255 characters)",
    },
    {
      header: "Remark",
      column: "C",
      example: "High priority calls",
...
export function CallTypeImport({}: CallTypeImportProps) {
  const form = useForm({
    defaultValues: {
      importFile: null,
    },
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            {/*<div className="mt-4 p-4 border rounded-lg bg-card">*/}
              <h4 className="font-semibold mb-2">Call Type Import Instructions</h4>
