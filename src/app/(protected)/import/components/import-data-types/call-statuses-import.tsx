...
// - Purpose: Display import instructions for call status data and a file input field
...
interface CallStatusImportProps {
...
const importConfig = {
  ...
  filename: "callstatus_import_template.xlsx",
  columns: [
    {
      header: "Name",
      column: "A",
      example: "In Progress",
      description: "CallStatus name (Required, 2-50 characters)",
    },
    {
      header: "Description",
      column: "B",
      example: "Call is currently being handled by an agent",
      description: "CallStatus description (Optional, max 255 characters)",
    },
    {
      header: "Remark",
      column: "C",
      example: "Monitor for escalation",
...
export function CallStatusImport({}: CallStatusImportProps) {
  const form = useForm({
    defaultValues: {
      importFile: null,
    },
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <Card>
          <CardContent className="p-4 sm:p-6">
              <h4 className="font-semibold mb-2">Call Status Import Instructions</h4>
