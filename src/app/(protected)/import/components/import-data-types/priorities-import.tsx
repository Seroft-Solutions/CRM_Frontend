...
// - Purpose: Display import instructions for priority data and a file input field
...
const importConfig = {
  ...
  filename: "priority_import_template.xlsx",
  columns: [
    {
      header: "Name",
      column: "A",
      example: "High",
      description: "Priority name (Required, 2-50 characters)",
    },
    {
      header: "Description",
      column: "B",
      example: "Urgent issues requiring immediate attention",
      description: "Priority description (Optional, max 255 characters)",
    },
    {
      header: "Remark",
      column: "C",
      example: "Escalate to manager if not resolved within SLA",
...
export function PriorityImport({}: PriorityImportProps) {
  const form = useForm({
    defaultValues: {
      importFile: null,
    },
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <Card>
          <CardContent className="p-4 sm:p-6">
              <h4 className="font-semibold mb-2">Priority Import Instructions</h4>
