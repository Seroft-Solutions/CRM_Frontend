...
// - Purpose: Display import instructions for sub-call type data and a file input field
...
interface SubCallTypeImportProps {
...
const importConfig = {
  instructions: [
    ...
    "CallType Name must match an existing CallType name exactly",
    "Empty rows will be skipped",
    "Save the file as .xlsx or .xls format",
  ],
  filename: "subcalltype_import_template.xlsx",
  columns: [
    {
      header: "Name",
      column: "A",
      example: "Technical Support",
      description: "SubCallType name (Required, 2-50 characters)",
    },
    {
      header: "Description",
      column: "B",
      example: "Handle technical issues and troubleshooting",
      description: "SubCallType description (Optional, max 255 characters)",
    },
    {
      header: "Remark",
      column: "C",
      example: "Escalate to level 2 if unresolved",
    ...
    },
    {
      ...
      description: "Parent CallType name (Required)",
    },
  ],
};

export function SubCallTypeImport({}: SubCallTypeImportProps) {
  const form = useForm({
    defaultValues: {
      importFile: null,
    },
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <Card>
          <CardContent className="p-4 sm:p-6">
              <h4 className="font-semibold mb-2">SubCall Type Import Instructions</h4>
