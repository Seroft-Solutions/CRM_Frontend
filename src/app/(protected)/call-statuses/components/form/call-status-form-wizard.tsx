...
import { CallStatusFormProvider, useEntityForm } from "./call-status-form-provider";
  ...
  const { mutate: createEntity, isPending: isCreating } = useCreateCallStatus({
    mutation: {
      onSuccess: (data) => {
        ...
        console.log('🟢 CallStatus created successfully with ID:', entityId);
        ...
        if (hasReferrer() && entityId) {
          ...
          console.log('🟢 No referrer, going to call-statuses list');
          setIsRedirecting(true);
      ...
      onError: (error) => {
        console.error('🔴 CallStatus creation failed:', error);
