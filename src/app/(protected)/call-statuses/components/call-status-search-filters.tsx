...
interface CallStatusSearchAndFiltersProps {
  searchTerm: string;
...
export function CallStatusSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <div>
                    ...
                    <Select
                      value={filters["isFinal"] as string || ""}
                      onValueChange={(value) => onFilterChange("isFinal", value || undefined)}
                    >
