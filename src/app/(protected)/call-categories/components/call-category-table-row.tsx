...
export function CallCategoryTableRow({
  ...
  return (
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-3 py-2">{callCategory.name}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{callCategory.description}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{callCategory.remark}</TableCell>
