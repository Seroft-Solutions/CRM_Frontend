...
interface CallCategorySearchAndFiltersProps {
  searchTerm: string;
...
export function CallCategorySearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters
}: CallCategorySearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search call categories..."
            value={searchTerm}
