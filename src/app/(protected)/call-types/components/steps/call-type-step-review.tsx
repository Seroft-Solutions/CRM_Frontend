...
interface CallTypeStepReviewProps {
  form: UseFormReturn<any>;
}

export function CallTypeStepReview({ form }: CallTypeStepReviewProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-lg font-medium">Review Call Type</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core calltype details</CardDescription>
          </CardHeader>
