  ...
  const { mutate: createEntity, isPending: isCreating } = useCreateCallType({
    mutation: {
      onSuccess: (data) => {
        ...
        console.log('🟢 CallType created successfully with ID:', entityId);
        ...
        if (hasReferrer() && entityId) {
          ...
          console.log('🟢 No referrer, going to call-types list');
          setIsRedirecting(true);
      ...
      onError: (error) => {
        console.error('🔴 CallType creation failed:', error);
