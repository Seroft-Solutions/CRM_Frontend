...
export function CityDetails({ id }: CityDetailsProps) {
  ...
  const { data: entity, isLoading, refetch } = useGetCity(id, {
    query: {
      enabled: !!id,
    },
  });
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">City #id{entity.id}</CardTitle>
          <CardDescription>
            View details for this city
          </CardDescription>
        </CardHeader>
