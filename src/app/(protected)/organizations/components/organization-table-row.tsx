...
export function OrganizationTableRow({
  ...
  return (
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-3 py-2">{organization.keycloakOrgId}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{organization.name}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{organization.displayName}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{organization.domain}</TableCell>
