...
export const meetingParticipantValidationHelpers = {
  validateStep: (stepId: string, data: Partial<MeetingParticipantFormValues>) => {
    const stepSchema = meetingParticipantStepSchemas[stepId as keyof typeof meetingParticipantStepSchemas];
  ...
  validateField: (fieldName: string, value: any) => {
    const fieldSchema = meetingParticipantFieldSchemas[fieldName as keyof typeof meetingParticipantFieldSchemas];
