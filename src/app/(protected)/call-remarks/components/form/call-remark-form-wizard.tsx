  ...
  const { mutate: createEntity, isPending: isCreating } = useCreateCallRemark({
    mutation: {
      onSuccess: (data) => {
        ...
        console.log('🟢 CallRemark created successfully with ID:', entityId);
        ...
        if (hasReferrer() && entityId) {
          ...
          console.log('🟢 No referrer, going to call-remarks list');
          setIsRedirecting(true);
      ...
      onError: (error) => {
        console.error('🔴 CallRemark creation failed:', error);
