  ...
  return (
    <TableRow>
      <TableCell className="w-12 px-3 py-2">
        <Checkbox checked={isSelected} onCheckedChange={() => party.id && onSelect(party.id)} />
      </TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.name}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.mobile}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.email}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.whatsApp}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.contactPerson}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.address1}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.address2}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.address3}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{party.remark}</TableCell>
