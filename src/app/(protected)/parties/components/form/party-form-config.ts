...
/**
 * Configuration for Party form
 * This file is auto-generated. To modify the form structure, update the generator templates.
 */
export const partyFormConfig: FormConfig = {
  entity: 'Party',
...
export const partyFormHelpers = {
  getStepById: (stepId: string) => partyFormConfig.steps.find(step => step.id === stepId),
  getFieldConfig: (fieldName: string) => partyFormConfig.fields.find(field => field.name === fieldName),
  getRelationshipConfig: (relationshipName: string) => partyFormConfig.relationships.find(rel => rel.name === relationshipName),
  getStepFields: (stepId: string) => {
    const step = partyFormConfig.steps.find(s => s.id === stepId);
