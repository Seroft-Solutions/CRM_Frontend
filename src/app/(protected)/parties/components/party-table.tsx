...
export function PartyTable() {
  ...
  const { mutate: updateEntity, isPending: isUpdating } = usePartialUpdateParty({
    mutation: {
      onSuccess: () => {
        refetch();
      },
  ...
  const confirmBulkDelete = async () => {
    ...
    try {
      ...
      toast.success(`${selectedRows.size} parties deleted successfully`);
      setSelectedRows(new Set());
      refetch();
    } catch (error) {
            ...
            {isLoading ? (
              ...
              data.map((party) => (
                <PartyTableRow
                  ...
                  isSelected={selectedRows.has(party.id || 0)}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              selected parties and remove their data from the server.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
