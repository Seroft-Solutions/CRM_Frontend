    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Address1
            <div className="text-gray-400">{renderSortIcon('address1')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Address2
            <div className="text-gray-400">{renderSortIcon('address2')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Address3
            <div className="text-gray-400">{renderSortIcon('address3')}</div>
          </Button>
        </TableHead>
