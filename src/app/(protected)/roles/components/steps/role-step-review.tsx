...
interface RoleStepReviewProps {
  form: UseFormReturn<any>;
}

export function RoleStepReview({ form }: RoleStepReviewProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-lg font-medium">Review Role</h3>
            ...
            <div className="flex flex-col space-y-1">
              ...
              <span className="text-sm font-medium">
                {formValues.users?.length > 0 ? 
                  `${formValues.users.length} user${formValues.users.length !== 1 ? 's' : ''} assigned` : 
