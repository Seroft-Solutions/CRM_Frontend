    ...
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          isEditable={
            relationshipConfigs.find((config) => config.name === 'priority')?.isEditable || false
          }
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          options={
            relationshipConfigs.find((config) => config.name === 'subCallType')?.options || []
          }
          displayField="name"
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={
            relationshipConfigs.find((config) => config.name === 'subCallType')?.isEditable || false
          }
          isLoading={isUpdating}
          className="min-w-[150px]"
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={
            relationshipConfigs.find((config) => config.name === 'source')?.isEditable || false
          }
          isLoading={isUpdating}
          className="min-w-[150px]"
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          options={
            relationshipConfigs.find((config) => config.name === 'callCategory')?.options || []
          }
          displayField="name"
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={
            relationshipConfigs.find((config) => config.name === 'callCategory')?.isEditable ||
            false
          }
          isLoading={isUpdating}
          className="min-w-[150px]"
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={
            relationshipConfigs.find((config) => config.name === 'callStatus')?.isEditable || false
          }
          isLoading={isUpdating}
          className="min-w-[150px]"
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          options={
            relationshipConfigs.find((config) => config.name === 'channelParty')?.options || []
          }
          displayField="email"
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={
            relationshipConfigs.find((config) => config.name === 'channelParty')?.isEditable ||
            false
          }
          isLoading={isUpdating}
          className="min-w-[150px]"
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={
            relationshipConfigs.find((config) => config.name === 'party')?.isEditable || false
          }
          isLoading={isUpdating}
          className="min-w-[150px]"
