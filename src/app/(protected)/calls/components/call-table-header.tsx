    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Assigned To
            <div className="text-gray-400">{renderSortIcon('assignedTo.email')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Channel Party
            <div className="text-gray-400">{renderSortIcon('channelParty.email')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Party
            <div className="text-gray-400">{renderSortIcon('party.name')}</div>
          </Button>
        </TableHead>
