...
function AreaFormContent({ id }: AreaFormProps) {
  ...
  const { mutate: createEntity, isPending: isCreating } = useCreateArea({
    mutation: {
      onSuccess: (data) => {
        ...
        console.log('🟢 Area created successfully with ID:', entityId);
        ...
        if (hasReferrer() && entityId) {
          ...
          console.log('🟢 No referrer, going to areas list');
          setIsRedirecting(true);
          areaToast.created();
          router.push("/areas");
        }
