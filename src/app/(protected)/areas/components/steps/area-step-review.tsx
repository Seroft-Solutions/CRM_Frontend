...
interface AreaStepReviewProps {
  form: UseFormReturn<any>;
}

export function AreaStepReview({ form }: AreaStepReviewProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-lg font-medium">Review Area</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core area details</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col space-y-1">
              ...
              <span className="text-sm font-medium">
                {formValues.pincode || <span className="text-muted-foreground italic">Not set</span>}
              </span>
            </div>
          </CardContent>
        </Card>
