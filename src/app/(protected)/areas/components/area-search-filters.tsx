...
interface AreaSearchAndFiltersProps {
  searchTerm: string;
...
export function AreaSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => onFilterChange("areaType", e.target.value || undefined)}
                      className="h-8"
                    />
                  </div>
