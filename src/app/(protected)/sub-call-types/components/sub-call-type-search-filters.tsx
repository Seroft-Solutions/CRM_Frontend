...
interface SubCallTypeSearchAndFiltersProps {
  searchTerm: string;
...
export function SubCallTypeSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters
}: SubCallTypeSearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search sub call types..."
            value={searchTerm}
