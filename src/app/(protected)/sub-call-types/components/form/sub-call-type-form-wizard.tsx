  ...
  const { mutate: createEntity, isPending: isCreating } = useCreateSubCallType({
    mutation: {
      onSuccess: (data) => {
        ...
        console.log('🟢 SubCallType created successfully with ID:', entityId);
        ...
        if (hasReferrer() && entityId) {
          ...
          console.log('🟢 No referrer, going to sub-call-types list');
          setIsRedirecting(true);
      ...
      onError: (error) => {
        console.error('🔴 SubCallType creation failed:', error);
