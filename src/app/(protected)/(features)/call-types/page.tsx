...
import { CallTypeTable } from "@/app/(protected)/(features)/call-types/components/call-type-table";
...
export default function CallTypePage() {
  return (
    <PermissionGuard 
      ...
      unauthorizedTitle="Access Denied to Call Types"
      unauthorizedDescription="You don't have permission to view call types."
    >
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                <h1 className="text-2xl font-bold leading-tight">Call Types</h1>
                <p className="text-blue-100 leading-tight">Manage your call types</p>
              </div>
            </div>
