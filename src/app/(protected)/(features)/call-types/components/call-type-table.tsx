...
const COLUMN_VISIBILITY_KEY = 'call-type-table-columns'; // v2 to force reset for auditing fields
...
export function CallTypeTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'call-type-table-columns'; // Old key without version
