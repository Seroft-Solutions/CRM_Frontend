...
import { CallTypeForm } from './form/call-type-form-wizard';
...
/**
 * Main entry point for the CallType form.
 ...
 * - form/call-type-form-config.ts (generated from templates)
 *
 ...
 */
export function CallTypeFormWrapper({ id }: CallTypeFormProps) {
  return <CallTypeForm id={id} />;
}

// Export with original name for backward compatibility
export { CallTypeFormWrapper as CallTypeForm };
