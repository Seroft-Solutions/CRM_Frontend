...
// ===============================================================
import { CallTypeForm } from '@/app/(protected)/(features)/call-types/components/call-type-form';
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-6 shadow-lg relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div className="text-white">
              <h1 className="text-2xl font-bold">Create Call Type</h1>
              <p className="text-blue-100">Enter the details below to create a new call type</p>
            </div>
          </div>
        </div>
