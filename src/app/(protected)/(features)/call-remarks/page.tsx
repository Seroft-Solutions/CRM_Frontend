...
import { CallRemarkTable } from "@/app/(protected)/(features)/call-remarks/components/call-remark-table";
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                <h1 className="text-2xl font-bold leading-tight">Call Remarks</h1>
                <p className="text-blue-100 leading-tight">Manage your call remarks</p>
              </div>
            </div>
