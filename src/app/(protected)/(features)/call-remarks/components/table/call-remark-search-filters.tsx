...
interface CallRemarkSearchAndFiltersProps {
  searchTerm: string;
...
export function CallRemarkSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters,
}: CallRemarkSearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search call remarks..."
            value={searchTerm}
          ...
          <DropdownMenuContent className="w-80 p-4" align="end">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2">
                  <label className="text-xs text-muted-foreground mb-1 block">dateTime Range</label>
                  <Popover>
