...
const COLUMN_VISIBILITY_KEY = 'call-remark-table-columns'; // v2 to force reset for auditing fields
...
export function CallRemarkTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'call-remark-table-columns'; // Old key without version
