...
/**
 * Main entry point for the City form.
 ...
 * - form/city-form-config.ts (generated from templates)
 *
 ...
 */
export function CityFormWrapper({ id }: CityFormProps) {
  return <CityForm id={id} />;
}

// Export with original name for backward compatibility
export { CityFormWrapper as CityForm };
