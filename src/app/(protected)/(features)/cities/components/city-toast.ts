...
// Toast notification utilities for City
export const cityToast = {
  // Success messages
  created: (entityName?: string) => 
    toast.success("✅ Success!", {
      description: `${entityName || 'City'} created successfully`,
      action: {
        label: "View",
  ...
  updated: (entityName?: string) => 
    toast.success("✅ Updated!", {
      description: `${entityName || 'City'} updated successfully`,
      action: {
        label: "View All",
        onClick: () => window.location.href = "/cities"
      }
  ...
  deleted: (entityName?: string) => 
    toast.success("🗑️ Deleted!", {
      description: `${entityName || 'City'} deleted successfully`
    }),
    
  bulkDeleted: (count: number) => 
    toast.success("🗑️ Bulk Delete!", {
      description: `${count} cities deleted successfully`
    }),
  ...
  exported: (format: string) => 
    toast.success("📤 Exported!", {
      description: `Cities exported to ${format} successfully`
    }),
    
  imported: (count: number) => 
    toast.success("📥 Imported!", {
      description: `${count} cities imported successfully`
    }),

  // Error messages
  createError: (error?: string) => 
    toast.error("❌ Creation Failed", {
      description: error || `Failed to create city. Please try again.`,
      action: {
        label: "Retry",
  ...
  updateError: (error?: string) => 
    toast.error("❌ Update Failed", {
      description: error || `Failed to update city. Please try again.`,
      action: {
        label: "Retry",
        onClick: () => window.location.reload()
      }
  ...
  deleteError: (error?: string) => 
    toast.error("❌ Delete Failed", {
      description: error || `Failed to delete city. Please try again.`
    }),
    
  bulkDeleteError: (error?: string) => 
    toast.error("❌ Bulk Delete Failed", {
      description: error || `Failed to delete selected cities. Please try again.`
    }),
