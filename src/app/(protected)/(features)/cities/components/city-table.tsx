...
const COLUMN_VISIBILITY_KEY = 'city-table-columns'; // v2 to force reset for auditing fields
...
export function CityTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'city-table-columns'; // Old key without version
