...
interface CityFormProviderProps {
...
export function CityFormProvider({ children, id, onSuccess, onError }: CityFormProviderProps) {
...
export function useEntityForm(): FormContextValue {
  ...
  if (!context) {
    throw new Error('useEntityForm must be used within a CityFormProvider');
  }
  return context;
}
