...
import { cityToast } from '../city-toast';
...
export function BulkRelationshipAssignment({
  ...
  const handleBulkUpdate = async () => {
    if (!selectedRelationship) {
      cityToast.validationError(['relationship field']);
      return;
    }
    ...
    try {
      ...
      cityToast.custom.error('❌ Bulk Update Failed', `Failed to update ${selectedRelationship}`);
    } finally {
      setIsUpdating(false);
    }
  };
