...
interface UserDraftSearchAndFiltersProps {
  searchTerm: string;
...
export function UserDraftSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters,
}: UserDraftSearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search user drafts..."
            value={searchTerm}
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    ...
                    <Input
                      placeholder="Filter by keycloakUserId..."
                      value={(filters['keycloakUserId'] as string) || ''}
                      onChange={(e) =>
                        onFilterChange('keycloakUserId', e.target.value || undefined)
                      }
                      className="h-8"
                    />
                  </div>
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">jsonPayload</label>
                    <Input
