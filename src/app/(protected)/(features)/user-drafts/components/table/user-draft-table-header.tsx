...
interface UserDraftTableHeaderProps {
...
export function UserDraftTableHeader({ 
  onSort, 
  getSortIcon,
  filters,
  onFilterChange,
          ...
          >
            {column.type === 'field' ? (
              (() => {
                ...
                if (column.accessor === 'keycloakUserId') {
                ...
                if (column.accessor === 'jsonPayload') {
