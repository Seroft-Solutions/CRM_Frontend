...
/**
 * Main entry point for the UserDraft form.
 ...
 * - form/user-draft-form-config.ts (generated from templates)
 *
 ...
 */
export function UserDraftFormWrapper({ id }: UserDraftFormProps) {
  return <UserDraftForm id={id} />;
}

// Export with original name for backward compatibility
export { UserDraftFormWrapper as UserDraftForm };
