...
import {
  ...
  useGetAllUserDrafts,
  useSearchUserDrafts,
  useUpdateUserDraft} from '@/core/api/generated/spring/endpoints/user-draft-resource/user-draft-resource.gen';
...
export function UserDraftTable() {
  ...
  const statusOptions = [
    ...
    {
      value: UserDraftDTOStatus.ACTIVE,
      label: transformEnumValue('ACTIVE'),
      color: 'bg-green-100 text-green-800'},
    {
      value: UserDraftDTOStatus.INACTIVE,
      label: transformEnumValue('INACTIVE'),
      color: 'bg-yellow-100 text-yellow-800'},
    {
      value: UserDraftDTOStatus.ARCHIVED,
  ...
  const getStatusFilter = () => {
    switch (activeStatusTab) {
      case 'draft':
        return { 'status.equals': UserDraftDTOStatus.DRAFT };
      case 'active':
        return { 'status.equals': UserDraftDTOStatus.ACTIVE };
      case 'inactive':
        return { 'status.equals': UserDraftDTOStatus.INACTIVE };
      case 'archived':
        return { 'status.equals': UserDraftDTOStatus.ARCHIVED };
      case 'all':
        return {};
      default:
        return { 'status.equals': UserDraftDTOStatus.ACTIVE };
  ...
  const confirmArchive = () => {
    if (archiveId) {
      ...
      if (currentEntity) {
        updateEntityStatus({
          id: archiveId,
          data: { ...currentEntity, status: UserDraftDTOStatus.ARCHIVED }});
      }
    }
    ...
    <>
      ...
      <div className="w-full space-y-4">
        ...
        <AlertDialog open={showBulkArchiveDialog} onOpenChange={setShowBulkArchiveDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will change the status of the selected user drafts to "Archived". They will no
        ...
        <AlertDialog open={showBulkStatusChangeDialog} onOpenChange={setShowBulkStatusChangeDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will update the status of the selected user drafts to "
        ...
        <AlertDialog open={showArchiveDialog} onOpenChange={setShowArchiveDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Archive this userdraft?</AlertDialogTitle>
              <AlertDialogDescription>
                This will change the status to "Archived". The userdraft will no longer appear in
        ...
        <AlertDialog open={showStatusChangeDialog} onOpenChange={setShowStatusChangeDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Change the status of this userdraft to "
