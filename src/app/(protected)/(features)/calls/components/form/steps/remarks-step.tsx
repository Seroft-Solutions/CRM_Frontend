    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Press Ctrl+Enter to quickly add a remark</p>
        </div>
              ...
              {remarks.map((remark) => (
                ...
                >
                  <div className="flex-1 space-y-1">
                    <div className="text-sm whitespace-pre-wrap break-words">{remark.remark}</div>
