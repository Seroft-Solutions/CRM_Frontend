          ...
          render={({ field }) => (
            <RelationshipRenderer
              relConfig={{
                ...
                required: false,
                multiple: false,
                autoPopulate: {"sourceField":"channelParties","targetField":"channelType","sourceProperty":"channelType","allowOverride":true},
                api: {"useGetAllHook":"useGetAllChannelTypes","useSearchHook":"useSearchChannelTypes","useCountHook":"useCountChannelTypes","entityName":"ChannelTypes"},
                creation: {"canCreate":true,"createPath":"/channel-types/new","createPermission":"channelType:create:inline"},
