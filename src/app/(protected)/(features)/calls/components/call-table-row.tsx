    ...
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-1 py-2">
        <RelationshipCell
          ...
          options={relationshipConfigs.find(config => config.name === "channelCustomer")?.options || []}
          displayField="login"
          onUpdate={onRelationshipUpdate || (() => Promise.resolve())}
          isEditable={relationshipConfigs.find(config => config.name === "channelCustomer")?.isEditable || false}
          isLoading={isUpdating}
          className="min-w-[150px]"
