...
import { RoleTable } from "@/app/(protected)/(features)/roles/components/role-table";
...
export default function RolePage() {
  return (
    <PermissionGuard 
      ...
      unauthorizedTitle="Access Denied to Roles"
      unauthorizedDescription="You don't have permission to view roles."
    >
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                ...
                <p className="text-blue-100 leading-tight">Manage your roles</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <InlinePermissionGuard requiredPermission="role:create">
