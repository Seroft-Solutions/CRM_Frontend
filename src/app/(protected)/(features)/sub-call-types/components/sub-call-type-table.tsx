...
const COLUMN_VISIBILITY_KEY = 'sub-call-type-table-columns'; // v2 to force reset for auditing fields
...
export function SubCallTypeTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'sub-call-type-table-columns'; // Old key without version
