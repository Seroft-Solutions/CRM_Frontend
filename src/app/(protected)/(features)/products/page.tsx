...
import { ProductTable } from "@/app/(protected)/(features)/products/components/product-table";
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                <h1 className="text-2xl font-bold leading-tight">Products</h1>
                <p className="text-blue-100 leading-tight">Manage your products</p>
              </div>
            </div>
