...
const COLUMN_VISIBILITY_KEY = 'priority-table-columns'; // v2 to force reset for auditing fields
...
export function PriorityTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'priority-table-columns'; // Old key without version
