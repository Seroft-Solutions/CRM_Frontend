...
export function CallStatusTableRow({
  ...
  return (
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-3 py-2">{callStatus.name}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{callStatus.description}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{callStatus.remark}</TableCell>
