...
// Toast notification utilities for CallStatus
export const callStatusToast = {
  // Success messages
  created: (entityName?: string) => 
    toast.success("✅ Success!", {
      description: `${entityName || 'Call Status'} created successfully`,
      action: {
        label: "View",
        onClick: () => window.location.href = "/call-statuses"
      }
    }),
    
  updated: (entityName?: string) => 
    toast.success("✅ Updated!", {
      description: `${entityName || 'Call Status'} updated successfully`,
      action: {
        label: "View All",
        onClick: () => window.location.href = "/call-statuses"
      }
  ...
  deleted: (entityName?: string) => 
    toast.success("🗑️ Deleted!", {
      description: `${entityName || 'Call Status'} deleted successfully`
    }),
    
  bulkDeleted: (count: number) => 
    toast.success("🗑️ Bulk Delete!", {
      description: `${count} call statuses deleted successfully`
    }),
  ...
  exported: (format: string) => 
    toast.success("📤 Exported!", {
      description: `Call Statuses exported to ${format} successfully`
    }),
    
  imported: (count: number) => 
    toast.success("📥 Imported!", {
      description: `${count} call statuses imported successfully`
    }),

  // Error messages
  createError: (error?: string) => 
    toast.error("❌ Creation Failed", {
      description: error || `Failed to create callstatus. Please try again.`,
      action: {
        label: "Retry",
  ...
  updateError: (error?: string) => 
    toast.error("❌ Update Failed", {
      description: error || `Failed to update callstatus. Please try again.`,
      action: {
        label: "Retry",
        onClick: () => window.location.reload()
      }
  ...
  deleteError: (error?: string) => 
    toast.error("❌ Delete Failed", {
      description: error || `Failed to delete callstatus. Please try again.`
    }),
    
  bulkDeleteError: (error?: string) => 
    toast.error("❌ Bulk Delete Failed", {
      description: error || `Failed to delete selected call statuses. Please try again.`
    }),
