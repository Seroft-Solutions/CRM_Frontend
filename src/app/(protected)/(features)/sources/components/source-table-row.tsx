...
export function SourceTableRow({
  ...
  return (
    <TableRow>
      ...
      <TableCell className="whitespace-nowrap px-3 py-2">{source.name}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{source.description}</TableCell>

      <TableCell className="whitespace-nowrap px-3 py-2">{source.remark}</TableCell>
