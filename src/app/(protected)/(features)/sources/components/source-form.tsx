...
/**
 * Main entry point for the Source form.
 ...
 * - form/source-form-config.ts (generated from templates)
 *
 ...
 */
export function SourceFormWrapper({ id }: SourceFormProps) {
  return <SourceForm id={id} />;
}

// Export with original name for backward compatibility
export { SourceFormWrapper as SourceForm };
