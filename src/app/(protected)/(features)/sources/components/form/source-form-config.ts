...
export const sourceFormConfig: FormConfig = {
  ...
  behavior: {
    ...
    persistence: {
      ...
      storagePrefix: 'SourceFormState_',
    },
    navigation: {
...
export const sourceFormHelpers = {
  ...
  getFieldConfig: (fieldName: string) => sourceFormConfig.fields.find(field => field.name === fieldName),
  getRelationshipConfig: (relationshipName: string) => sourceFormConfig.relationships.find(rel => rel.name === relationshipName),
  getStepFields: (stepId: string) => {
    const step = sourceFormConfig.steps.find(s => s.id === stepId);
