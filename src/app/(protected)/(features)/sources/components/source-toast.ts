...
// Toast notification utilities for Source
export const sourceToast = {
  // Success messages
  created: (entityName?: string) => 
    toast.success("✅ Success!", {
      description: `${entityName || 'Source'} created successfully`,
      action: {
        label: "View",
  ...
  updated: (entityName?: string) => 
    toast.success("✅ Updated!", {
      description: `${entityName || 'Source'} updated successfully`,
      action: {
        label: "View All",
        onClick: () => window.location.href = "/sources"
      }
  ...
  deleted: (entityName?: string) => 
    toast.success("🗑️ Deleted!", {
      description: `${entityName || 'Source'} deleted successfully`
    }),
    
  bulkDeleted: (count: number) => 
    toast.success("🗑️ Bulk Delete!", {
      description: `${count} sources deleted successfully`
    }),
  ...
  exported: (format: string) => 
    toast.success("📤 Exported!", {
      description: `Sources exported to ${format} successfully`
    }),
    
  imported: (count: number) => 
    toast.success("📥 Imported!", {
      description: `${count} sources imported successfully`
    }),

  // Error messages
  createError: (error?: string) => 
    toast.error("❌ Creation Failed", {
      description: error || `Failed to create source. Please try again.`,
      action: {
        label: "Retry",
  ...
  updateError: (error?: string) => 
    toast.error("❌ Update Failed", {
      description: error || `Failed to update source. Please try again.`,
      action: {
        label: "Retry",
        onClick: () => window.location.reload()
      }
  ...
  deleteError: (error?: string) => 
    toast.error("❌ Delete Failed", {
      description: error || `Failed to delete source. Please try again.`
    }),
    
  bulkDeleteError: (error?: string) => 
    toast.error("❌ Bulk Delete Failed", {
      description: error || `Failed to delete selected sources. Please try again.`
    }),
