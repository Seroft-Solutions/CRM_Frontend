...
export const availableTimeSlotValidationHelpers = {
  validateStep: (stepId: string, data: Partial<AvailableTimeSlotFormValues>) => {
    const stepSchema = availableTimeSlotStepSchemas[stepId as keyof typeof availableTimeSlotStepSchemas];
  ...
  validateField: (fieldName: string, value: any) => {
    const fieldSchema = availableTimeSlotFieldSchemas[fieldName as keyof typeof availableTimeSlotFieldSchemas];
