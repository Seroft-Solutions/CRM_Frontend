    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Slot Date Time
            <div className="text-gray-400">{renderSortIcon('slotDateTime')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Is Booked
            <div className="text-gray-400">{renderSortIcon('isBooked')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Booked At
            <div className="text-gray-400">{renderSortIcon('bookedAt')}</div>
          </Button>
        </TableHead>
