...
export default async function EditAvailableTimeSlotPage({ params }: EditAvailableTimeSlotPageProps) {
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white">
                <h1 className="text-2xl font-bold">Edit Available Time Slot</h1>
                <p className="text-blue-100">Update the information for this available time slot</p>
              </div>
            </div>
