...
import { OrganizationTable } from "@/app/(protected)/(features)/organizations/components/organization-table";
...
export default function OrganizationPage() {
  return (
    <PermissionGuard 
      ...
      unauthorizedTitle="Access Denied to Organizations"
      unauthorizedDescription="You don't have permission to view organizations."
    >
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                <h1 className="text-2xl font-bold leading-tight">Organizations</h1>
                <p className="text-blue-100 leading-tight">Manage your organizations</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <InlinePermissionGuard requiredPermission="organization:create">
