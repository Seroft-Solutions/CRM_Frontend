...
/**
 * Main entry point for the Organization form.
 ...
 * - form/organization-form-config.ts (generated from templates)
 *
 ...
 */
export function OrganizationFormWrapper({ id }: OrganizationFormProps) {
  return <OrganizationForm id={id} />;
}

// Export with original name for backward compatibility
export { OrganizationFormWrapper as OrganizationForm };
