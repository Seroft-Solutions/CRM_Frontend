          ...
          <InlinePermissionGuard requiredPermission="organization:update">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {currentStatus !== OrganizationDTOStatus.ACTIVE && (
                  <DropdownMenuItem
                    onClick={() => organization.id && onStatusChange(organization.id, 'ACTIVE')}
                ...
                {currentStatus !== OrganizationDTOStatus.INACTIVE && (
                  <DropdownMenuItem
                    onClick={() => organization.id && onStatusChange(organization.id, 'INACTIVE')}
                ...
                {currentStatus !== OrganizationDTOStatus.DRAFT && (
                  <DropdownMenuItem
                    onClick={() => organization.id && onStatusChange(organization.id, 'DRAFT')}
                ...
                {currentStatus !== OrganizationDTOStatus.ARCHIVED && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                      onClick={() => organization.id && onArchive(organization.id)}
