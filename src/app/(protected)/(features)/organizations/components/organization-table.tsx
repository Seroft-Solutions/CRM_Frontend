...
const COLUMN_VISIBILITY_KEY = 'organization-table-columns'; // v2 to force reset for auditing fields
...
export function OrganizationTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'organization-table-columns'; // Old key without version
