...
// Toast notification utilities for Meeting
export const meetingToast = {
  // Success messages
  created: (entityName?: string) => 
    toast.success("✅ Success!", {
      description: `${entityName || 'Meeting'} created successfully`,
      action: {
        label: "View",
  ...
  updated: (entityName?: string) => 
    toast.success("✅ Updated!", {
      description: `${entityName || 'Meeting'} updated successfully`,
      action: {
        label: "View All",
        onClick: () => window.location.href = "/meetings"
      }
  ...
  deleted: (entityName?: string) => 
    toast.success("🗑️ Deleted!", {
      description: `${entityName || 'Meeting'} deleted successfully`
    }),
    
  bulkDeleted: (count: number) => 
    toast.success("🗑️ Bulk Delete!", {
      description: `${count} meetings deleted successfully`
    }),
  ...
  exported: (format: string) => 
    toast.success("📤 Exported!", {
      description: `Meetings exported to ${format} successfully`
    }),
    
  imported: (count: number) => 
    toast.success("📥 Imported!", {
      description: `${count} meetings imported successfully`
    }),

  // Error messages
  createError: (error?: string) => 
    toast.error("❌ Creation Failed", {
      description: error || `Failed to create meeting. Please try again.`,
      action: {
        label: "Retry",
  ...
  updateError: (error?: string) => 
    toast.error("❌ Update Failed", {
      description: error || `Failed to update meeting. Please try again.`,
      action: {
        label: "Retry",
        onClick: () => window.location.reload()
      }
  ...
  deleteError: (error?: string) => 
    toast.error("❌ Delete Failed", {
      description: error || `Failed to delete meeting. Please try again.`
    }),
    
  bulkDeleteError: (error?: string) => 
    toast.error("❌ Bulk Delete Failed", {
      description: error || `Failed to delete selected meetings. Please try again.`
    }),
