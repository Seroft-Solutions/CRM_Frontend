...
import { MeetingTable } from "@/app/(protected)/(features)/meetings/components/meeting-table";
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                <h1 className="text-2xl font-bold leading-tight">Meetings</h1>
                <p className="text-blue-100 leading-tight">Manage your meetings</p>
              </div>
            </div>
