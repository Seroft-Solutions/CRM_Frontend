...
interface GroupSearchAndFiltersProps {
  searchTerm: string;
...
export function GroupSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    ...
                    <Input
                      placeholder="Filter by keycloakGroupId..."
                      value={(filters['keycloakGroupId'] as string) || ''}
                      onChange={(e) =>
                        onFilterChange('keycloakGroupId', e.target.value || undefined)
                      }
                      className="h-8"
                    />
                  </div>
