    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Keycloak Group Id
            <div className="text-gray-400">{renderSortIcon('keycloakGroupId')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Path
            <div className="text-gray-400">{renderSortIcon('path')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Organization
            <div className="text-gray-400">{renderSortIcon('organization.name')}</div>
          </Button>
        </TableHead>
