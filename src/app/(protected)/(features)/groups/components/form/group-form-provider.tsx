...
export function GroupFormProvider({ children, id, onSuccess, onError }: GroupFormProviderProps) {
...
export function useEntityForm(): FormContextValue {
  ...
  if (!context) {
    throw new Error('useEntityForm must be used within a GroupFormProvider');
  }
  return context;
}
