...
const COLUMN_VISIBILITY_KEY = 'product-category-table-columns'; // v2 to force reset for auditing fields
...
export function ProductCategoryTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'product-category-table-columns'; // Old key without version
