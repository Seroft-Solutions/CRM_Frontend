...
/**
 * Main entry point for the CallCategory form.
 ...
 * - form/call-category-form-config.ts (generated from templates)
 *
 ...
 */
export function CallCategoryFormWrapper({ id }: CallCategoryFormProps) {
  return <CallCategoryForm id={id} />;
}

// Export with original name for backward compatibility
export { CallCategoryFormWrapper as CallCategoryForm };
