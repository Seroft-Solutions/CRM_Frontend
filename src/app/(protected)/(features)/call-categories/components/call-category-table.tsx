...
const COLUMN_VISIBILITY_KEY = 'call-category-table-columns';
...
export function CallCategoryTable() {
  ...
  const { data, isLoading, refetch } = useGetAllCallCategories(
    {
      page: apiPage,
      size: pageSize,
      sort: `${sort},${order}`,
  ...
  const { data: countData } = useCountCallCategories(filterParams, {
    query: {
      enabled: true,
    },
  });
  ...
  const handleRelationshipUpdate = async (
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      console.log(`Updating ${relationshipName} for CallCategory ${entityId}:`, updateData);
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                categories and remove their data from the server.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This action cannot be undone. This will permanently delete the callcategory and
