...
export function MeetingParticipantTable() {
  ...
  // Delete mutation
  const { mutate: deleteEntity, isPending: isDeleting } = useDeleteMeetingParticipant({
    mutation: {
      onSuccess: () => {
  ...
  const handleRelationshipUpdate = async (
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      console.log(`Updating ${relationshipName} for MeetingParticipant ${entityId}:`, updateData);
