...
interface MeetingParticipantSearchAndFiltersProps {
  searchTerm: string;
...
export function MeetingParticipantSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters,
}: MeetingParticipantSearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search meeting participants..."
            value={searchTerm}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">isRequired</label>
                    <Select
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">hasAccepted</label>
                    <Select
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">hasDeclined</label>
                    <Select
