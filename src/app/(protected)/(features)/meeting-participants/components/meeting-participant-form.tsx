...
/**
 * Main entry point for the MeetingParticipant form.
 ...
 * - form/meeting-participant-form-config.ts (generated from templates)
 *
 ...
 */
export function MeetingParticipantFormWrapper({ id }: MeetingParticipantFormProps) {
  return <MeetingParticipantForm id={id} />;
}

// Export with original name for backward compatibility
export { MeetingParticipantFormWrapper as MeetingParticipantForm };
