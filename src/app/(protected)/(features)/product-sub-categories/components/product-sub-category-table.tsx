...
const COLUMN_VISIBILITY_KEY = 'product-sub-category-table-columns'; // v2 to force reset for auditing fields
...
export function ProductSubCategoryTable() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const oldKey = 'product-sub-category-table-columns'; // Old key without version
          ...
          onSuccess: (serverResponse) => {
            ...
            if (isBulkOperation) {
              ...
              queryClient.setQueryData(
                ...
                (old: any[]) =>
                  old?.map((productSubCategory) =>
                    productSubCategory.id === entityId
