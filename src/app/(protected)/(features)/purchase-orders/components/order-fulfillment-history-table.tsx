          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50 border-slate-300">
                ...
                <TableHead className="text-center text-[11px] font-bold text-slate-500 uppercase tracking-wider">Received</TableHead>
                ...
                generations.map((generation) => (
                  ...
                  >
                    ...
                    <TableCell className="text-center">
                      <Badge variant="outline" className="border-slate-300 bg-white text-slate-700 ring-1 ring-slate-200">
