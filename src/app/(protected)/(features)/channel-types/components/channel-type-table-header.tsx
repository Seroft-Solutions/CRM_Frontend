...
interface ChannelTypeTableHeaderProps {
...
export function ChannelTypeTableHeader({
  onSort,
  getSortIcon,
  filters,
  onFilterChange,
    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Commission Rate
            <div className="text-gray-400">{renderSortIcon('commissionRate')}</div>
          </Button>
        </TableHead>
