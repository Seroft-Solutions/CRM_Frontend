...
export function ChannelTypeTable() {
  ...
  const { data, isLoading, refetch } = useGetAllChannelTypes(
    {
      page: apiPage,
      size: pageSize,
      sort: `${sort},${order}`,
  ...
  const { mutate: updateEntity, isPending: isUpdating } = usePartialUpdateChannelType({
    mutation: {
      onSuccess: () => {
  ...
  // Delete mutation
  const { mutate: deleteEntity, isPending: isDeleting } = useDeleteChannelType({
    mutation: {
      onSuccess: () => {
      ...
      <AlertDialog open={showBulkDeleteDialog} onOpenChange={setShowBulkDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the selected channel types
