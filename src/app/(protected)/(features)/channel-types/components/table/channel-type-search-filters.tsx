...
interface ChannelTypeSearchAndFiltersProps {
  searchTerm: string;
...
export function ChannelTypeSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters,
}: ChannelTypeSearchAndFiltersProps) {
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onFilterChange('commissionRate', e.target.value || undefined)
                      }
                      className="h-8"
                    />
                  </div>
