...
export function ChannelTypeTableRow({
  ...
  const currentStatus = channelType.status;
          ...
          <InlinePermissionGuard requiredPermission="channelType:update">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {currentStatus !== ChannelTypeDTOStatus.ACTIVE && (
                  <DropdownMenuItem
                    onClick={() => channelType.id && onStatusChange(channelType.id, 'ACTIVE')}
                ...
                {currentStatus !== ChannelTypeDTOStatus.INACTIVE && (
                  <DropdownMenuItem
                    onClick={() => channelType.id && onStatusChange(channelType.id, 'INACTIVE')}
                ...
                {currentStatus !== ChannelTypeDTOStatus.DRAFT && (
                  <DropdownMenuItem
                    onClick={() => channelType.id && onStatusChange(channelType.id, 'DRAFT')}
                ...
                {currentStatus !== ChannelTypeDTOStatus.ARCHIVED && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                      onClick={() => channelType.id && onArchive(channelType.id)}
