          ...
          >
            {column.type === 'field'
              ? (() => {
                  ...
                  if (column.accessor === 'isAvailable') {
                    return (
                      <Select
                  ...
                  if (column.accessor === 'effectiveFrom') {
                    return (
                      <Input
                        type="date"
                        ...
                        onChange={(e) =>
                          onFilterChange('effectiveFrom', e.target.value || undefined)
                        }
                      />
                    );
                  }

                  if (column.accessor === 'effectiveTo') {
                    return (
                      <Input
                        type="date"
                        className="h-8 text-xs border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
