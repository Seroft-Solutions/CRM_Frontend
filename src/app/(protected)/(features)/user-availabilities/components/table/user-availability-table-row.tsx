...
export function UserAvailabilityTableRow({
  ...
  const currentStatus = userAvailability.status;
          ...
          <InlinePermissionGuard requiredPermission="userAvailability:update">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {currentStatus !== UserAvailabilityDTOStatus.ACTIVE && (
                  <DropdownMenuItem
                    onClick={() =>
                      userAvailability.id && onStatusChange(userAvailability.id, 'ACTIVE')
                    }
                ...
                {currentStatus !== UserAvailabilityDTOStatus.INACTIVE && (
                  <DropdownMenuItem
                    onClick={() =>
                      userAvailability.id && onStatusChange(userAvailability.id, 'INACTIVE')
                    }
                ...
                {currentStatus !== UserAvailabilityDTOStatus.DRAFT && (
                  <DropdownMenuItem
                    onClick={() =>
                      userAvailability.id && onStatusChange(userAvailability.id, 'DRAFT')
                    }
                ...
                {currentStatus !== UserAvailabilityDTOStatus.ARCHIVED && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                      onClick={() => userAvailability.id && onArchive(userAvailability.id)}
