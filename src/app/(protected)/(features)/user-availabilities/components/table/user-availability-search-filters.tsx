...
interface UserAvailabilitySearchAndFiltersProps {
  searchTerm: string;
...
export function UserAvailabilitySearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters,
}: UserAvailabilitySearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search user availabilities..."
            value={searchTerm}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">isAvailable</label>
                    <Select
                      value={(filters['isAvailable'] as string) || '__all__'}
                      onValueChange={(value) =>
                        onFilterChange('isAvailable', value === '__all__' ? undefined : value)
                      }
                    >
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">dayOfWeek</label>
                    <Input
                      placeholder="Filter by dayOfWeek..."
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">startTime</label>
                    <Input
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">endTime</label>
                    <Input
