    ...
    <TableHeader>
      ...
      <TableRow className="border-b border-gray-200 bg-gray-50">
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Day Of Week
            <div className="text-gray-400">{renderSortIcon('dayOfWeek')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Start Time
            <div className="text-gray-400">{renderSortIcon('startTime')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            End Time
            <div className="text-gray-400">{renderSortIcon('endTime')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Is Available
            <div className="text-gray-400">{renderSortIcon('isAvailable')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Effective From
            <div className="text-gray-400">{renderSortIcon('effectiveFrom')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            Effective To
            <div className="text-gray-400">{renderSortIcon('effectiveTo')}</div>
          </Button>
        </TableHead>
        ...
        <TableHead className="whitespace-nowrap px-3 py-2">
          ...
          >
            User
            <div className="text-gray-400">{renderSortIcon('user.displayName')}</div>
          </Button>
        </TableHead>
