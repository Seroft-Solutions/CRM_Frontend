...
export const userAvailabilityFormSchemaFields = {
  dayOfWeek: z
    ...
    .min(1, { message: 'Please enter dayofweek' }),
  startTime: z
    .string({ message: 'Please enter starttime' })
    .min(1, { message: 'Please enter starttime' })
    .regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, { message: 'Please enter valid starttime' }),
  endTime: z
    .string({ message: 'Please enter endtime' })
    .min(1, { message: 'Please enter endtime' })
    .regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, { message: 'Please enter valid endtime' }),
