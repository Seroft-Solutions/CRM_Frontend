...
interface UserProfileSearchAndFiltersProps {
  searchTerm: string;
...
export function UserProfileSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        onFilterChange('internalUser.login', e.target.value || undefined)
                      }
                      className="h-8"
                    />
                  </div>
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">lastName</label>
                    <Input
