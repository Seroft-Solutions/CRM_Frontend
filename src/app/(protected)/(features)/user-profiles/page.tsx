...
import { UserProfileTable } from "@/app/(protected)/(features)/user-profiles/components/user-profile-table";
          ...
          <div className="flex items-center justify-between relative z-10 h-full">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white min-w-0">
                <h1 className="text-2xl font-bold leading-tight">User Profiles</h1>
                <p className="text-blue-100 leading-tight">Manage your user profiles</p>
              </div>
            </div>
