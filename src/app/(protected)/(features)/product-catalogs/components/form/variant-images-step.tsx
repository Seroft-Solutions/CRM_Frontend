  ...
  const imageOptions: VariantImageOption[] = variantIds.flatMap((variantId, index) => {
    ...
    return images
      ...
      .map((image, imageIndex) => {
        const value = image.cdnUrl || image.thumbnailUrl;
  ...
  return (
    <FormField
      ...
      render={({ field }) => {
        ...
        const previewUrl = selectedOption?.previewUrl || selectedValue;
                  ...
                  <div className="mt-4">
                    {selectedValue ? (
                      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        <div className="relative h-32 w-32 overflow-hidden rounded-md border bg-white">
                          <Image
                            src={previewUrl}
