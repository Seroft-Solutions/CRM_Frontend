...
import { ProductCatalogForm } from './form/product-catalog-form-wizard';
...
/**
 * Main entry point for the ProductCatalog form.
 ...
 * - form/product-catalog-form-config.ts (generated from templates)
 *
 ...
 */
export function ProductCatalogFormWrapper({ id }: ProductCatalogFormProps) {
  return <ProductCatalogForm id={id} />;
}

export { ProductCatalogFormWrapper as ProductCatalogForm };
