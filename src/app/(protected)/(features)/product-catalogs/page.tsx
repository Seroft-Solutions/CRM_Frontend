...
export default function ProductCatalogPage() {
  return (
    <PermissionGuard
      ...
      unauthorizedTitle="Access Denied to Product Catalogs"
      unauthorizedDescription="You don't have permission to view product catalogs."
    >
        ...
        <div className="bg-sidebar border border-sidebar-border rounded-md p-4 shadow-sm">
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-center gap-3 flex-1">
              ...
              <div>
                <h1 className="text-xl font-semibold text-sidebar-foreground">Product Catalogs</h1>
                <p className="text-sm text-sidebar-foreground/80">Manage product catalogs</p>
              </div>
            </div>
            ...
            <div className="flex-1 flex justify-center">
              <InlinePermissionGuard requiredPermission="productCatalog:create">
                ...
                >
                  <Link href="/product-catalogs/new">
