...
import { areaFormSchema } from '@/app/(protected)/(features)/areas/components/form/area-form-schema';
import {
  areaToast,
  handleAreaError,
...
export function AreaFormProvider({ children, id, onSuccess, onError }: AreaFormProviderProps) {
