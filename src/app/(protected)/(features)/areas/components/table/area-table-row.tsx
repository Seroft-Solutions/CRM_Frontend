  ...
  return (
    <TableRow className="hover:bg-gray-50 transition-colors">
      <TableCell className="w-10 sm:w-12 px-2 sm:px-3 py-2 sticky left-0 bg-white z-10">
        <Checkbox checked={isSelected} onCheckedChange={() => area.id && onSelect(area.id)} />
      </TableCell>
          ...
          <InlinePermissionGuard requiredPermission="area:update">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {currentStatus !== AreaDTOStatus.ACTIVE && (
                  <DropdownMenuItem
                    onClick={() => area.id && onStatusChange(area.id, 'ACTIVE')}
                ...
                {currentStatus !== AreaDTOStatus.INACTIVE && (
                  <DropdownMenuItem
                    onClick={() => area.id && onStatusChange(area.id, 'INACTIVE')}
                ...
                {currentStatus !== AreaDTOStatus.DRAFT && (
                  <DropdownMenuItem
                    onClick={() => area.id && onStatusChange(area.id, 'DRAFT')}
                ...
                {currentStatus !== AreaDTOStatus.ARCHIVED && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                      onClick={() => area.id && onArchive(area.id)}
