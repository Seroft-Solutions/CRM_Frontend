...
/**
 * Main entry point for the Area form.
 ...
 * - form/area-form-config.ts (generated from templates)
 *
 ...
 */
export function AreaFormWrapper({ id }: AreaFormProps) {
  return <AreaForm id={id} />;
}

// Export with original name for backward compatibility
export { AreaFormWrapper as AreaForm };
