...
export function AreaTable() {
  ...
  const getStatusFilter = () => {
    switch (activeStatusTab) {
      case 'draft':
        return { 'status.equals': AreaDTOStatus.DRAFT };
      case 'active':
        return { 'status.equals': AreaDTOStatus.ACTIVE };
      case 'inactive':
        return { 'status.equals': AreaDTOStatus.INACTIVE };
      case 'archived':
        return { 'status.equals': AreaDTOStatus.ARCHIVED };
      case 'all':
        return {};
      default:
        return { 'status.equals': AreaDTOStatus.ACTIVE };
        ...
        <AlertDialog open={showBulkArchiveDialog} onOpenChange={setShowBulkArchiveDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will change the status of the selected areas to "Archived". They will no longer
        ...
        <AlertDialog open={showBulkStatusChangeDialog} onOpenChange={setShowBulkStatusChangeDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will update the status of the selected areas to "
        ...
        <AlertDialog open={showArchiveDialog} onOpenChange={setShowArchiveDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will change the status to "Archived". The area will no longer appear in the
        ...
        <AlertDialog open={showStatusChangeDialog} onOpenChange={setShowStatusChangeDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Change the status of this area to "
