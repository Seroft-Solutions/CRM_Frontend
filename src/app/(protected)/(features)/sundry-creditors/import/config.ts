export const sundryCreditorImportConfig = {
  instructions: [
    ...
    'Creditor Name and Mobile are required',
    'Email and Contact Person are optional',
    'Zip Code is optional',
    'Save the file as .xlsx or .xls format',
  ],
  filename: 'sundry_creditor_import_template.xlsx',
  columns: [
    {
      column: 'A',
      header: 'Creditor Name',
      description: 'Creditor name (Required, 2-100 characters)',
