...
export default function SundryCreditorPage() {
    return (
        <PermissionGuard
            requiredPermission="sundryCreditor:read" // This permission needs to be added to the backend/DB
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <div className="flex items-center gap-3 flex-1">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-sidebar-foreground/80">Manage your sundry creditor database</p>
                            </div>
                        </div>

                        {/* Center Section: Prominent New Button */}
