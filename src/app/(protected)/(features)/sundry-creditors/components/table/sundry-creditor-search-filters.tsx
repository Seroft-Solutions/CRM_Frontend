...
interface SundryCreditorSearchAndFiltersProps {
  searchTerm: string;
...
export function SundryCreditorSearchAndFilters({
  searchTerm,
  onSearchChange,
  filters,
  onFilterChange,
  ...
  onClearAll,
  hasActiveFilters,
}: SundryCreditorSearchAndFiltersProps) {
    ...
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            placeholder="Search sundry creditors..."
            value={searchTerm}
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  <div>
                    ...
                    <Input
                      placeholder="Filter by creditorName..."
