...
interface SundryCreditorTableHeaderProps {
...
export function SundryCreditorTableHeader({
  onSort,
  getSortIcon,
  filters,
  onFilterChange,
  ...
  onSelectAll,
  visibleColumns,
}: SundryCreditorTableHeaderProps) {
      ...
      <TableRow className="border-b bg-white">
        ...
        {visibleColumns.map((column, index) => (
          ...
          >
            {column.type === 'field'
              ? (() => {
                  if (column.accessor === 'creditorName') {
                    return (
                      <Input
                        placeholder="Filter..."
                        className="h-8 text-xs border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-gray-400"
                        value={(filters['creditorName'] as string) || ''}
                        onChange={(e) =>
                          onFilterChange('creditorName', e.target.value || undefined)
                        }
                      />
                    );
                  }
                  ...
                  if (column.accessor === 'contactPerson') {
                    return (
                      <Input
                        placeholder="Filter..."
                        className="h-8 text-xs border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder:text-gray-400"
                        ...
                        onChange={(e) =>
                          onFilterChange('contactPerson', e.target.value || undefined)
                        }
                      />
                    );
                  }
