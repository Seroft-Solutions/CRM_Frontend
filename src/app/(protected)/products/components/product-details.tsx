  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardDescription>
            Viewing details for Product #id{entity.id}
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="border-l-4 border-primary/20 pl-4 py-2">
                    <dt className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Code</dt>
                    <dd className="text-base font-medium">
                  ...
                  <div className="border-l-4 border-primary/20 pl-4 py-2">
                    <dt className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Category</dt>
                    <dd className="text-base font-medium">
                  ...
                  <div className="border-l-4 border-primary/20 pl-4 py-2">
                    <dt className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Base Price</dt>
                    <dd className="text-base font-medium">
                  ...
                  <div className="border-l-4 border-primary/20 pl-4 py-2">
                    <dt className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Min Price</dt>
                    <dd className="text-base font-medium">
                  ...
                  <div className="border-l-4 border-primary/20 pl-4 py-2">
                    <dt className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Max Price</dt>
                    <dd className="text-base font-medium">
