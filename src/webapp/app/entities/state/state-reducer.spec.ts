...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STATES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATE actions', async () => {
      const arg = { id: 6174 };
    ...
    it('dispatches UPDATE_STATE actions', async () => {
      const arg = { id: 6174 };
    ...
    it('dispatches PARTIAL_UPDATE_STATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATE actions', async () => {
      const arg = 42666;
