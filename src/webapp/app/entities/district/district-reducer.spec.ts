...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTRICT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DISTRICTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISTRICT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISTRICT actions', async () => {
      const arg = { id: 19151 };
    ...
    it('dispatches UPDATE_DISTRICT actions', async () => {
      const arg = { id: 19151 };
    ...
    it('dispatches PARTIAL_UPDATE_DISTRICT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISTRICT actions', async () => {
      const arg = 42666;
