...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIORITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRIORITIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIORITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIORITY actions', async () => {
      const arg = { id: 19881 };
    ...
    it('dispatches UPDATE_PRIORITY actions', async () => {
      const arg = { id: 19881 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIORITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIORITY actions', async () => {
      const arg = 42666;
