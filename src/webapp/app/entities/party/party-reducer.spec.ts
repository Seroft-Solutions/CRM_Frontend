...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PARTIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTY actions', async () => {
      const arg = { id: 17981 };
    ...
    it('dispatches UPDATE_PARTY actions', async () => {
      const arg = { id: 17981 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTY actions', async () => {
      const arg = 42666;
