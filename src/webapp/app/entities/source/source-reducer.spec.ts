...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOURCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SOURCES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOURCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOURCE actions', async () => {
      const arg = { id: 467 };
    ...
    it('dispatches UPDATE_SOURCE actions', async () => {
      const arg = { id: 467 };
    ...
    it('dispatches PARTIAL_UPDATE_SOURCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOURCE actions', async () => {
      const arg = 42666;
