...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALLREMARK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CALLREMARKS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALLREMARK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALLREMARK actions', async () => {
      const arg = { id: 434 };
    ...
    it('dispatches UPDATE_CALLREMARK actions', async () => {
      const arg = { id: 434 };
    ...
    it('dispatches PARTIAL_UPDATE_CALLREMARK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CALLREMARK actions', async () => {
      const arg = 42666;
