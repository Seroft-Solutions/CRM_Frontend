...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALLCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CALLCATEGORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALLCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALLCATEGORY actions', async () => {
      const arg = { id: 23814 };
    ...
    it('dispatches UPDATE_CALLCATEGORY actions', async () => {
      const arg = { id: 23814 };
    ...
    it('dispatches PARTIAL_UPDATE_CALLCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CALLCATEGORY actions', async () => {
      const arg = 42666;
