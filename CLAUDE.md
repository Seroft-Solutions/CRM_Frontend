...
#### Feature Organization (`src/app/(protected)/(features)/`)
...
**Note**: Steering documents are optional but highly recommended for
consistency.
...
- **ALL** tasks must reference specific requirements using _Requirements: X.Y_
  format
